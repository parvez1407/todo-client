                    ...
                    <div className="w-full max-w-md p-8 space-y-3 rounded-xl dark:bg-cyan-900 dark:text-gray-100 mt-10">
                        ...
                        <form onSubmit={handleLogIn} className="space-y-6 ng-untouched ng-pristine ng-valid">
                            <div className="space-y-1 text-sm">
                                ...
                                <input type="email" name="email" id="userEmail" placeholder="Enter Your Email" className="w-full px-4 py-3 rounded-md dark:bg-gray-800 dark:text-gray-100 outline-cyan-400" required />
                            </div>
                            <div className="space-y-1 text-sm">
                                <label htmlFor="password" className="block dark:text-gray-400">Password</label>
                                <input type="password" name="password" id="password" placeholder="Enter Your Password" className="w-full px-4 py-3 rounded-md dark:bg-gray-800 dark:text-gray-100 outline-cyan-400" required />
